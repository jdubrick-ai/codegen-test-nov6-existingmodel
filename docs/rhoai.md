...
3) Access the `workbench` named `codegen-test-nov6-existingmodel-notebook`
...
5) In the terminal, run `cd codegen-test-nov6-existingmodel` to navigate to your sample app's directory
